...
const ChampionshipLeaderBoard = ({ blueMarlineChampionSip }) => {
  ...
  const leaderBoardDataHandler = () => {
    ...
    if (
      Array.isArray(blueMarlineChampionSip) &&
      blueMarlineChampionSip.length > 0
    ) {
      blueMarlineChampionSip.forEach((record) => {
  ...
  return (
    <>
      ...
      {/* Day 1 Table */}
      <div className="table-section">
        <div className="title">Day 1 - 14th February 2025</div>
        <div className="table-row my-2">
      ...
      {/* Day 2 Table */}
      <div className="table-section">
        <div className="title">Day 2 - 15th February 2025</div>
        <div className="table-row my-2">
