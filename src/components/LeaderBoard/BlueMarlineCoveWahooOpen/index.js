...
const WahooOpenLeaderBoard = () => {
  ...
  const totalCalcutta = {
    total_heaviest_10: 3000,
    total_daily_heaviest_fish: 3000,
    total_daily_aggregate: 3000,
    total_overall_heavy_fish: 3000,
  };

  const touranmentDayRecordsTableColumn = [
    { Header: "Boat Name", accessor: "boat_name" },
    { Header: "Captain Name", accessor: "captain_name" },
    { Header: "Fish Weight.1", accessor: (row) => row.fish_weights?.[0] || "---" },
    { Header: "Fish Weight.2", accessor: (row) => row.fish_weights?.[1] || "---" },
    { Header: "Fish Weight.3", accessor: (row) => row.fish_weights?.[2] || "---" },
    { Header: "Fish Weight.4", accessor: (row) => row.fish_weights?.[3] || "---" },
    { Header: "Fish Weight.5", accessor: (row) => row.fish_weights?.[4] || "---" },
    {
      Header: "Total Weight (lbs)",
      accessor: (row) => row.total_weight || "---",
      id: "total_weight",
  ...
  const totalWeightRecordTableColumn = [
    { Header: "Boat Name", accessor: "boat_name" },
    { Header: "Captain Name", accessor: "captain_name" },
    { Header: "Day 1", accessor: (row) => row.day_1_total || "---" },
    { Header: "Day 2", accessor: (row) => row.day_2_total || "---" },
    {
      Header: "Total Weight (lbs)",
      accessor: (row) => row.total_weight || "---",
      id: "total_weight",
  ...
  return (
    <>
      <div className="table-section">
        <div className="title">Overall Scoress</div>
        <div className="table-row my-2">
          <Table
            columns={totalWeightRecordTableColumn}
            data={wahooOpenData?.overall_weight}
      ...
      {/* Add the static versions of these if needed */}
      {/* <OverallHeaviest10Tournament data={wahooOpenData.overall_weight} totalAmount={totalCalcutta.total_heaviest_10} /> */}
      {/* <HeaviestFishofEachDay data={wahooOpenData} totalAmount={totalCalcutta.total_daily_heaviest_fish} /> */}
      {/* <DailyAggregate day_1_data={wahooOpenData.day_1} day_2_data={wahooOpenData.day_2} totalAmount={totalCalcutta.total_daily_aggregate} /> */}
      {/* <HeaviestFishOfTheTournament data={wahooOpenData} totalAmount={totalCalcutta.total_overall_heavy_fish} /> */}
    </>
  );
};
